...
(** TLS reporter *)
module Tls (C : Mirage_console.S) (CLOCK : Mirage_clock.PCLOCK) (STACK : Tcpip.Stack.V4V6) (KV : Mirage_kv.RO) : sig
...
(** {2:mirage_example Example usage}
    ...
    following snippet:
{[
module Main (C : Mirage_console.S) (S : Tcpip.Stack.V4V6) (CLOCK : Mirage_clock.PCLOCK) (KEYS : Mirage_kv.RO)
