...
(** TLS reporter *)
module Tls (CLOCK : Mirage_clock.PCLOCK) (STACK : Mirage_stack.V4) (KV : Mirage_kv.RO) : sig
...
(** {2:mirage_example Example usage}
    ...
    following snippet:
{[
module Main (S : Mirage_stack.V4) (CLOCK : Mirage_clock.PCLOCK) (KEYS : Mirage_kv.RO)
